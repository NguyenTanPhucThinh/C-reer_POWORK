...
export function SkillsRubricSummary({ verifiedSkills, skillSummary }: SkillsRubricSummaryProps) {
  ...
  return (
    ...
    >
      <div className="mb-4">
        <p className="mb-1 text-xs font-medium text-accent">Tổng quan kỹ năng</p>
        <h2 className="text-2xl font-semibold text-foreground">Năng lực đã xác thực</h2>
      </div>

      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div>
          <p className="mb-3 text-base font-medium text-foreground-secondary">
            Các kỹ năng, cấp độ và tín hiệu challenge đã xác thực
          </p>
